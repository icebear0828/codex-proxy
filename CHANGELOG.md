...
- Retry early upstream `server_error` responses once on a different account before streaming; forward the real upstream error body only after retry exhaustion while preserving already-started streams.
